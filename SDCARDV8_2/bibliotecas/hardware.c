...
void init_interrupt(void)
{
	...
	PIE1    = 0b00001000;   //SSPIE Enables the MSSP interrupt 
...
void init_ports(void)
{
    TRISB = 0b00100001;        // por que bit 5 = 1??    
	LATB  = 0xFF;
    TRISD = 0x00;           
    TRISA = 0b00000111; 
    TRISC = 0x01111111;         // correto
    TRISE = 0b00000011;
...
void config_timer_dois(void)
{
    ...
    TMR2 = 0;
//    PR2 = 0x1E;
    PR2 = 0x78;  //deixie com 120 aqui para 10Mhz se não errei o cálculo
}
