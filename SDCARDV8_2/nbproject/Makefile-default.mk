...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/SDCARDV8_2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=bibliotecas/GPS.c bibliotecas/diskio.c bibliotecas/display_lcd.c bibliotecas/hardware.c bibliotecas/tff.c bibliotecas/uart.c main.c bibliotecas/adc.c bibliotecas/SDCard.c bibliotecas/SPI.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/bibliotecas/GPS.p1 ${OBJECTDIR}/bibliotecas/diskio.p1 ${OBJECTDIR}/bibliotecas/display_lcd.p1 ${OBJECTDIR}/bibliotecas/hardware.p1 ${OBJECTDIR}/bibliotecas/tff.p1 ${OBJECTDIR}/bibliotecas/uart.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/bibliotecas/adc.p1 ${OBJECTDIR}/bibliotecas/SDCard.p1 ${OBJECTDIR}/bibliotecas/SPI.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/bibliotecas/GPS.p1.d ${OBJECTDIR}/bibliotecas/diskio.p1.d ${OBJECTDIR}/bibliotecas/display_lcd.p1.d ${OBJECTDIR}/bibliotecas/hardware.p1.d ${OBJECTDIR}/bibliotecas/tff.p1.d ${OBJECTDIR}/bibliotecas/uart.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/bibliotecas/adc.p1.d ${OBJECTDIR}/bibliotecas/SDCard.p1.d ${OBJECTDIR}/bibliotecas/SPI.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/bibliotecas/GPS.p1 ${OBJECTDIR}/bibliotecas/diskio.p1 ${OBJECTDIR}/bibliotecas/display_lcd.p1 ${OBJECTDIR}/bibliotecas/hardware.p1 ${OBJECTDIR}/bibliotecas/tff.p1 ${OBJECTDIR}/bibliotecas/uart.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/bibliotecas/adc.p1 ${OBJECTDIR}/bibliotecas/SDCard.p1 ${OBJECTDIR}/bibliotecas/SPI.p1

# Source Files
SOURCEFILES=bibliotecas/GPS.c bibliotecas/diskio.c bibliotecas/display_lcd.c bibliotecas/hardware.c bibliotecas/tff.c bibliotecas/uart.c main.c bibliotecas/adc.c bibliotecas/SDCard.c bibliotecas/SPI.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/SDCARDV8_2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/SDCARDV8_2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/SDCARDV8_2.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --emi=wordwrite --rom=default,-6280-7fff --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/SDCARDV8_2.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/SDCARDV8_2.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/SDCARDV8_2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/SDCARDV8_2.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --rom=default,-6280-7fff --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/SDCARDV8_2.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
