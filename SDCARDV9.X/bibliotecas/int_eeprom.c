 ...
 *****************************************************************************/
void escreve_eeprom_interna (unsigned int address, unsigned char data)
{
    /* Write Operation*/
    EEADR=address;			
    EEDATA=data;			
 ...
 * Descrição:	Função principal
 *****************************************************************************/
unsigned char leitura_eeprom_interna(unsigned int address)
{
    /*Read operation*/
 ...
 * Descrição:	Função principal
 *****************************************************************************/
void escreve_string_eeprom_interna(unsigned int address, unsigned char *data)
{
