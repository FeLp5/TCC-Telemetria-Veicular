...
class Relatorio(wx.Panel):
    ...
    def atual(self):
        ...
        for x in range(len(vars.nome_rua)):
            ...
            itens = itens + "<tr><td>" + hora + "</td><td>" + vars.nome_rua[x]+ "</td><td>" + vars.cidade[x] + "</td><td>" + vars.estado[x] + "</td><td>" + vars.vetor_velocidade[x] + " Km/h</td><td>" + vars.speed_limit[x] + " Km/h</td><td style='text-align: center'>" + alerta + "</td><td>"+ vars.vetor_fence[x] + "</td></tr>"
