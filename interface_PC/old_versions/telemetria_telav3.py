...
class janelas(wx.Frame):
    ...
    # def arquivos(scrolled.ScrolledPanel):
        ...
        for x in range(5):
            count = count + 22
            self. botao = wx.Button(self, wx.NewId(x), convert_data((titulo_bt[x])), (10, count), (larg * 2, 20))  
            self.botao.SetBackgroundColour(corBotoes)
            botoes = botoes + 1
        ...
        self.Bind(wx.EVT_BUTTON, self.abrir_arquivos, self.botao)
