...
class Painel_arquivos(wx.Panel):
    ...
    def abrir_recentes(self, nbotao):
        ...
        s_botoes(self)
        global titulo_bt
        titulo_bt = self.bt_camho[nbotao] # pegando o nome do arquivo e tornando global
    ...
    def abrir_arquivos(self, event):
        with wx.FileDialog(self, "Abrir arquivo de telemetria", wildcard="arquivos tlm  (*.tlm)|*.tlm",
            ...
            global titulo_bt
            titulo_bt = pathname # pegando o nome do arquivo e tornando global
...
class Painel_infos(wx.Panel):
    ...
    def mostrar_dados(self):
        ...
        self.statxt_arquivo.SetLabel("Arquivo " + titulo_bt + "     --- VIN: " + VIN)
...
class Painel(wx.Frame):
    ...
    def InitUI(self):
        ...
        pn_id = Painel_inferior_direito(panel)
        ...
        # self.Bind(wx.EVT_MENU, pn_id.show_panel_one, informacoes)
